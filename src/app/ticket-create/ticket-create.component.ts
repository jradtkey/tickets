...
export class TicketCreateComponent implements OnInit {
  ...
  onCreateTicket(form: NgForm) {
    ...
    this.ticketService.addTicket(form.value.platform, form.value.inquiry_type, form.value.guest_name, form.value.check_in, form.value.check_out, form.value.property, form.value.property_owner, this.enteredPlatformImage, 'Account Type', 'Unresolved', 'User', 'user2')
    form.resetForm();
  }
